from employee import Employee #employee is the file name, Employee is the class name
...
def main():  #define the main program 
    ...
    employee1 = Employee('Sarah', 'Hess', 50000)  #add new employees to the comp
    my_company.add_employee(employee1)
    employee2 = Employee('Lee', 'Smith', 50000) 
